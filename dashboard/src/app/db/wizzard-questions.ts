...
export const wizzardQuestions: Question[] = [
  {
    ...
    answers: [
      { id: 1, prefix: 'a', text: 'CD, CSec, CPO, CI', isCorrect: false },
      { id: 2, prefix: 'b', text: 'CSec, CPO, CPrep, CD', isCorrect: true },
      { id: 3, prefix: 'c', text: 'CSec, CPO, CD, CD', isCorrect: false },
      { id: 4, prefix: 'd', text: 'CPO, Csec, CPrep, CD', isCorrect: false },
    ],
  ...
  },
  {
    ...
    answers: [
      { id: 1, prefix: 'a', text: 'Earth', isCorrect: false },
      { id: 2, prefix: 'b', text: 'Mars', isCorrect: true },
      { id: 3, prefix: 'c', text: 'Jupiter', isCorrect: false },
      { id: 4, prefix: 'd', text: 'Saturn', isCorrect: false },
    ],
    userSelectedAnswerId: null,
  ...
  },
  {
    ...
    answers: [
      { id: 1, prefix: 'a', text: 'Atlantic Ocean', isCorrect: false },
      { id: 2, prefix: 'b', text: 'Indian Ocean', isCorrect: false },
      { id: 3, prefix: 'c', text: 'Arctic Ocean', isCorrect: false },
      { id: 4, prefix: 'd', text: 'Pacific Ocean', isCorrect: true },
    ],
    userSelectedAnswerId: null,
  ...
  },
  {
    ...
    answers: [
      { id: 1, prefix: 'a', text: 'William Shakespeare', isCorrect: true },
      { id: 2, prefix: 'b', text: 'Charles Dickens', isCorrect: false },
      { id: 3, prefix: 'c', text: 'Mark Twain', isCorrect: false },
      { id: 4, prefix: 'd', text: 'Jane Austen', isCorrect: false },
    ],
    userSelectedAnswerId: null,
